...
let num = [0,1,2,3,4,5];
let num2 = num.slice(2,5);
console.log(num2);

let Num = ["t", "e", "s", "t"];

alert( Num.slice(1, 3) ); // e,s (copy from 1 to 3)

alert( Num.slice(-2) ); // s,t (copy from -2 till the end)
...
// syntax => arr.concat(arg1, arg2...)
 ...
 let Num2 = Num1.concat(6, "seven", [8,9], [10,11,12]);
 console.log(Num2);
...
alert( arr0.concat(arrayLike) ); // 1,2,[object , object]
console.log(arr0);
...
alert( arr01.concat(arrayLike1) ); // 1,2,something,else
